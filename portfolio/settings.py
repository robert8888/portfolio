...
ALLOWED_HOSTS = ['*.herokuapp.com', 'rkaminski.herokuapp.com', "127.0.0.1"]
...
django_heroku.settings(locals(), staticfiles = False, secret_key = False, databases = False, test_runner = False)